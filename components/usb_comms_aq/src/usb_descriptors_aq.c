...
const tusb_desc_device_t tusb_desc_device_aq = {
    ...
    .idProduct          = 0x4003, // Custom Product ID for AquaController ECM
    .bcdDevice          = 0x0100,
...
const uint8_t tusb_desc_configuration_aq[] = {
    ...
    TUD_CDC_ECM_DESCRIPTOR(ITF_NUM_CDC_CTRL, STRID_CDC_INTERFACE, STRID_MAC, EPNUM_NET_NOTIF, 64, EPNUM_NET_OUT, EPNUM_NET_IN, CFG_TUD_NET_ENDPOINT_SIZE, 1514),
};
...
const char* tusb_string_descriptors[] = {
    ...
    [STRID_PRODUCT]       = "ECM USB Device",
    [STRID_SERIAL]        = "1234567890AB",
    [STRID_MAC]           = mac_str_ascii,
    [STRID_CDC_INTERFACE] = "AquaController ECM",
};
